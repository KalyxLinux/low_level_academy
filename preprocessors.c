// Preprocessor step : the compiler looks over all the code and/ before it does ANYTHING.

// Here are some of those macros:
...
#if : Codnitional compilation directive.
    Example : #if DEBUG
...
#line : Specifies the original line nunmber and filenane.
    Example : #line 28 "myfile.cpp"

#warning (GCC) : Generates a compiler warning with a specified nesaage (GCC).
